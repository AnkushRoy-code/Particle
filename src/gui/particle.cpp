...
//---------------------------------------------------------------------------
particle::particle(float x, float y, int color) : m_x(x), m_y(y), m_vx(0), m_vy(0), m_color(color)
{
}
                      ...
                      bool Wrap)
{
    ...
    for (const auto &other: Particles)
    {
        ...
        float distance = std::hypot(dx, dy);  // hypot does this: (x*x + y*y)^0.5 since it
